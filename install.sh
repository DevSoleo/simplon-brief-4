...
resource_group="test_thomas_app_gateway"

# Administration
admin_name="thomas"
password="2022Simplon!"
fqdn="thomas${iteration}"
local="francecentral"

# Network Resources
vnet_name="vnet_test_th"
subnet_name="app_subnet_th"

# Virtual Machines Resources 
bastion_name="bastion_th_1"
psql_server_name="psql-th"
database_name="db-th"
vm_app_name="vmapp"
...
- hosts: localhost
  ...
  - import_tasks: ../models/scale_model.yml" > ./tmp/ansible_tmp.yml
